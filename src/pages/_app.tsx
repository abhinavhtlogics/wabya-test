...
const App = (props: ExtendedAppProps) => {
  ...
  return (
    <CacheProvider value={emotionCache}>
      ...
      { router.pathname === '/super-admin/dashboard' || router.pathname === '/super-admin/client-list' || router.pathname === '/super-admin/coaches-list' || router.pathname === '/super-admin/edit-profile' || router.pathname === '/super-admin/change-password' || router.pathname === '/super-admin/plans'  ?
      (
        <SettingsProvider>
          <SettingsConsumer>
            {({ settings }) => {
